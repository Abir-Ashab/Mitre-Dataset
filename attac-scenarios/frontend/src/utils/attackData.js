...
export const attackSteps = {
  initialAccess: [
    ...
    "Payload from public GitHub repo by downloading full repo (click exe directly)",
    "Payload from public GitHub repo by downloading full repo (click to a pdf file)",
    "Payload from public GitHub repo by downloading full repo (Run the project)",
    "Payload from public GitHub repo by downloading the file only (click exe directly)",
    "Payload from public GitHub repo by downloading the file only (click to a pdf file)",
    "Payload from public GitHub repo by downloading the file only (Run the project)",
